  ...
  return (
    <div className='w-full px-[12%] py-10 scroll-mt-20' id='services'>
        ...
        <p className='text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo'>
            ...
            I provide comprehensive solutions tailored to your needs.</p>

            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 my-10">
                {serviceData.map(({icon,title,description,link},index)=>(
                    <div key={index}
                     className='border-[0.5px] border-gray-400 rounded-lg px-8
                     ...
                     hover:-translate-y-1 duration-500'>
                        ...
                        <p className='text-sm text-gray-600 leading-5 font-Ovo'>
                            {description}
                        </p>
                        <a href={link} className="flex items-center gap-2 text-sm mt-5 font-Ovo">
