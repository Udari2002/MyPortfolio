     ...
     flex items-center justify-between z-50'>
        ...
        <div className='flex items-center gap-4'>
            ...
            <a className="hidden lg:flex items-center gap-3 px-10 py-2.5 border
             border-gray-500 rounded-full font-Ovo" href="#contact">Contact 
             <Image src={assets.arrow_icon} alt="arrow icon" className='w-3' /></a>
        ...
        top-0 bottom-0 w-64 z-50 h-screen bg-rose-50 transition duration-500 transform translate-x-full'>
